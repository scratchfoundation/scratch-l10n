...
/**
 * @typedef {'default'
 *  |'reviewed'|'proofread'|'translator'|'untranslated'
 *  |'onlytranslated'|'onlyreviewed'|'onlyproofread'|'sourceastranslation'
 * } TransifexMode
 */

/**
 * A single message or translation, in Chrome i18n format.
 * @typedef {object} chromei18nMessage
 * @property {string} message - the message content (either source string or translation)
 * @property {string} description - description or context information about this message
 * @property {Record<string,object>} [placeholders] - information about placeholders in the message
 */

/**
 * A mapping of ID to message, in Chrome i18n format.
 * @typedef {Record<string,chromei18nMessage>} chromei18nCollection
 */
 ...
 * @param {TransifexMode} mode - translation status of strings to include
 ...
 * @param {TransifexMode} mode - translation status of strings to include
 * @returns {Promise<chromei18nCollection>} - JSON object of translated resource strings (or, of the
 * original resource strings, if the local is the source language)
 */
 ...
 * @returns {Promise<string[]>} - array of strings, slugs identifying each resource in the project
 */
...
const txAvailableLanguages = async function (slug) {
    ...
    const languages = /** @type {Collection} */ (await project.fetch('languages'));
